# Campaign Helper v1.3
# Excel workflow assistant
...
Write-Host "  Campaign Helper - Standard" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
while ($true) {
    ...
    switch ($cmd.ToLower().Trim()) {
        ...
        default { if ($cmd -ne "") { Write-Host "Error" -ForegroundColor Red
    }
}
